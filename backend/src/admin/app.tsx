...
export default {
  ...
  bootstrap(app: StrapiApp) {
    if (typeof document !== 'undefined') {
      ...
      style.textContent = `
        /* Un-trap position: sticky from Better Blocks container overflow without affecting page scroll containers */
        div:has(> [role="toolbar"]):has([data-slate-editor="true"]) {
          overflow: visible !important;
        }

        /* Sticky formatting toolbar for Better Blocks Rich Text Editor */
        div:has(> [role="toolbar"]):has([data-slate-editor="true"]) > [role="toolbar"]:not([aria-label="Text formatting"]) {
        ...
        body:has([data-strapi-header-sticky="true"]) div:has(> [role="toolbar"]):has([data-slate-editor="true"]) > [role="toolbar"]:not([aria-label="Text formatting"]) {
        ...
        [role="dialog"] div:has(> [role="toolbar"]) > [role="toolbar"]:not([aria-label="Text formatting"]) {
          position: sticky !important;
          top: 0 !important;
          z-index: 20 !important;
          background-color: inherit !important;
